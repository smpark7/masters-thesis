...
established codes \cite{leppanen_calculation_2014}.
...
and the outer loop region where the heat exchanger is located. The central
core region specifically refers to the central region indicated by
...
Pa$\cdot$s. Despite the simplicity of this assumption, the resulting flow profile is
