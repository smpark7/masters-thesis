...
While the limitations of the multi-group neutron diffusion compared to other
...
Salt flow in the core is governed by the standard incompressible Navier-Stokes
equations:
%
\begin{align}
