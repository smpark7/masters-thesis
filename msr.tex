...
Fiorina et al.
\cite{fiorina_modelling_2014} in 2014 for a 2-D axisymmetric model of the
\gls{MSFR}. The authors compared \gls{MSFR} simulations results from both
tools, in which they dubbed the COMSOL and DALTON/HEAT tools the Polimi and
TUDelft models, respectively, after the universities where each tool was
developed. With multigroup
...
thermal-hydraulics against MCNP and a FLUENT-based model, respectively, before
presenting their multiphysics steady-state results with a 2-D axisymmetric
...
compare our results to results published by Fiorina et al.
